...
```
Mỗi đơn cứu hộ → 5% vào quỹ bảo hiểm

Ví dụ:
Patient trả:     500,000 đ
├─ Rescuer (85%): 425,000 đ
├─ Platform (10%):  50,000 đ
└─ BẢO HIỂM (5%):  25,000 đ → Vào quỹ
```
...
```
[Bước 1] Rescuer/gia đình báo tai nạn (24h)
    ↓
[Bước 2] Platform xác minh (48h)
    ├─ Kiểm tra hồ sơ y tế
    ├─ Xác nhận Rescuer đang làm việc
    └─ Xem camera/GPS nếu cần
    ↓
[Bước 3] Phê duyệt mức chi (24h)
    ├─ Cấp 1-2: Admin duyệt
    └─ Cấp 3-5: Hội đồng duyệt
    ↓
[Bước 4] Chuyển tiền (24h)
